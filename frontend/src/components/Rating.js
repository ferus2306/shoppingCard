...
// snipcode to automatically import prop types: impt
...
const Rating = ({ value, text, color }) => {
    return (
        <div className='rating'>
            ...
            <span>
                <i style={{color: color}} className={value >= 5 ? 'fas fa-star' : value >= 5.5 ? 'fas fa-star-half-alt' : 'far fa-star'}></i>
            </span>
            <span> {text && text} </span>
        </div>
    )
